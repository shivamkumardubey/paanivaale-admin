...
@Component({
  selector: "ngx-o-eventorders",
  templateUrl: "./o-eventorders.component.html",
  styleUrls: ["./o-eventorders.component.scss"]
})
export class OEventordersComponent {
  // settings = {
  //   actions: false,
  //   mode: "external",
  //   add: {
  ...
  view(data) {
    this.router.navigate([
      "/pages/users-tables/eventorders-activity",
      data.order_id
    ]);
  }
  ngOnInit(): void {
    this.service.getdata_eventsorders().subscribe(
      res => {
        this.tableShow = true;
