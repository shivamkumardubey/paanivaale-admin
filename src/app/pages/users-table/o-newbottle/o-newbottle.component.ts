...
@Component({
  selector: "ngx-o-newbottle",
  templateUrl: "./o-newbottle.component.html",
  styleUrls: ["./o-newbottle.component.scss"]
})
export class ONewbottleComponent {
  // settings = {
  //   actions: false,
  //   mode: "external",
  //   add: {
  ...
  view(data) {
    this.router.navigate([
      "/pages/users-tables/newbottle-activity",
      data.order_id
    ]);
  }
  ngOnInit(): void {
    this.service.getdata_newbottleorders().subscribe(
      res => {
        this.tableShow = true;
