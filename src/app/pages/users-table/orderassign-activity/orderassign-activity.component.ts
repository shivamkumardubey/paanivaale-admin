...
@Component({
  selector: "ngx-orderassign-activity",
  templateUrl: "./orderassign-activity.component.html",
  styleUrls: ["./orderassign-activity.component.scss"]
})
export class OrderassignActivityComponent {
  constructor(
