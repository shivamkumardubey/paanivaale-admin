...
@Component({
  selector: "ngx-o-eventorders-assign-activity",
  templateUrl: "./o-eventorders-assign-activity.component.html",
  styleUrls: ["./o-eventorders-assign-activity.component.scss"]
})
export class OEventordersAssignActivityComponent {
  constructor(
