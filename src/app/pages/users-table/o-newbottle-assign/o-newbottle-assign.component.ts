...
@Component({
  selector: "ngx-o-newbottle-assign",
  templateUrl: "./o-newbottle-assign.component.html",
  styleUrls: ["./o-newbottle-assign.component.scss"]
})
export class ONewbottleAssignComponent {
  // settings = {
  //   actions: false,
  //   mode: "external",
  //   add: {
  ...
  ngOnInit(): void {
    this.service.getdata_assignneworders().subscribe(
      res => {
        this.tableShow = true;
