...
@Component({
  selector: "ngx-o-newbottle-activity",
  templateUrl: "./o-newbottle-activity.component.html",
  styleUrls: ["./o-newbottle-activity.component.scss"]
})
export class ONewbottleActivityComponent {
  constructor(
      ...
      this.service
        ...
        .subscribe(
          res => {
            ...
            this.router.navigate(["/pages/users-tables/newbottle"]);
          },
          error => {
            console.log(error);
            alert(error.error.message);
