...
@Component({
  selector: "ngx-complainsolveactivity",
  templateUrl: "./complainsolveactivity.component.html",
  styleUrls: ["./complainsolveactivity.component.scss"]
})
export class ComplainsolveactivityComponent {
  constructor(
    ...
    this.service
      ...
      .subscribe(
        res => {
          ...
          if (res.success === true) {
            alert("user updated");
            this.router.navigate(["pages/users-tables/solve"]);
          } else {
