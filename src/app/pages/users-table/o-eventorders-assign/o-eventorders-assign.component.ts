...
@Component({
  selector: "ngx-o-eventorders-assign",
  templateUrl: "./o-eventorders-assign.component.html",
  styleUrls: ["./o-eventorders-assign.component.scss"]
})
export class OEventordersAssignComponent {
  // settings = {
  //   actions: false,
  //   mode: "external",
  //   add: {
  ...
  ngOnInit(): void {
    this.service.getdata_assigneventorders().subscribe(
      res => {
        this.tableShow = true;
