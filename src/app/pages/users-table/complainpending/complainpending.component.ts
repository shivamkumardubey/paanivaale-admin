...
@Component({
  selector: "ngx-complainpending",
  templateUrl: "./complainpending.component.html",
  styleUrls: ["./complainpending.component.scss"]
})
export class ComplainpendingComponent {
  // settings = {
  //   actions: false,
  //   mode: "external",
  //   add: {
  ...
  view(data) {
    this.router.navigate(["/pages/users-tables/pending-activity", data.id]);
  }
  ngOnInit(): void {
    this.service.getdata_pendingcomplain().subscribe(
      res => {
        this.tableShow = true;
